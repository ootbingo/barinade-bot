...
import ootbingo.barinade.bot.racing_services.srl.api.client.deserialize.DurationDeserializer
import java.time.Duration

data class SrlResult(
    var race: Long = 0, var place: Long = 0, var player: String = "",
